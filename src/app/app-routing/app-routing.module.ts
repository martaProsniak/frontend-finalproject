...
const appRoutes: Routes = [
  ...
  { path: 'users/:orderid', component: UserDetailsComponent, canActivate: [AuthGuard], data: { roles: [Role.Admin]}},
  { path: 'users/edit/:orderid', component: UserEditComponent, canActivate: [AuthGuard]},
  { path: 'users/delete/:orderid', component: UserDeleteComponent, canActivate: [AuthGuard], data: { roles: [Role.Admin]} },
  { path: 'users/activate/:orderid', component: UserActivationComponent, canActivate: [AuthGuard], data: { roles: [Role.Admin]} },
  { path: 'products-json', component: ProductJsonComponent, canActivate: [AuthGuard], data: { roles: [Role.Admin]}},
  { path: 'products-users/:orderid', component: UsersProductsComponent, canActivate: [AuthGuard]},
  { path: 'products-add', component: ProductAddComponent, canActivate: [AuthGuard]},
  { path: 'products/edit/:orderid', component: ProductEditComponent, canActivate: [AuthGuard]},
  { path: 'products/delete/:orderid', component: ProductDeleteComponent, canActivate: [AuthGuard] },
  { path: 'orders', component: OrderListComponent, canActivate: [AuthGuard]},
  { path: 'cart/users/:orderid', component: CartComponent, canActivate: [AuthGuard]},
